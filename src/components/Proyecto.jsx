...
function Proyecto() {
    ...
    const { obtenerProyecto, proyecto, cargando, eliminarProyecto, alerta, handleSetModalTarea } = useProyectos();
    ...
    return (
        cargando ? <Loading /> : (
            <>
                ...
                <button className='flex gap-3 items-center justify-center w-full md:w-auto mt-6 bg-sky-400 px-5 py-3 rounded-lg text-white text-center text-sm font-bold uppercase' onClick={handleSetModalTarea}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                ...
                <div className='bg-white rounded-lg shadow mt-10'>
                    {proyecto.tareas?.length ? (
                        ...
                        <p className='text-center my-10 p-10 uppercase text-red-500 font-bold text-xl'>
